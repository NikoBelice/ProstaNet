...
class GeneralLayer(nn.Module):
    ...
    def __init__(self, name, dim_in, dim_out, dropout, **kwargs):
        super(GeneralLayer, self).__init__()
        self.layer = layer_dict[name](dim_in, dim_out, **kwargs)
        layer_post = []
        layer_post.append(nn.ReLU())
        layer_post.append(nn.Dropout(dropout))
...
class GeneralMultiLayer(nn.Module):
    ...
    def __init__(self, name, num_layers, dim_in, dim_out, dim_inner, dropout, **kwargs):
        ...
        for i in range(num_layers):
            ...
            layer = GeneralLayer(name, d_in, d_out, dropout, **kwargs)
