...
for fold, (train_indices, val_indices) in enumerate(kfold.split(dir_dataset)):
  ...
  trainloader = DataLoader(dataset=trainset, batch_size=32, num_workers=0, shuffle=True, drop_last=True)
  validateloader = DataLoader(dataset=validateset, batch_size=32, num_workers=0, shuffle=True, drop_last=True)
